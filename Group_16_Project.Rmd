...
setwd("E:/Program Files/RStudio/DataAnalysisSkill/DAS_Project2")
...
After the initial graphical analysis of the relationship between the variables, we will use the GLM model to further analyse the relationship between the outcome variables (Time_at_Shelter)and the explanatory variables(Animal_type,Month,Year,Intake_type,Chip_Status), and the model will be based on poisson GLM model, since the response variable is the count of the number of days animal spentat the shelter, with link function log.So,the model(1) will be like this: $$

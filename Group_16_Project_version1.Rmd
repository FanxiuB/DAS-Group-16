...
Animal protection has now become a growing concern in society and animal being admitted to the shelter is one of the conservation measures.The purpose of this report is to use the Generalised Linear Model to analyse whether the days of animals spent at the shelter between being admitted and the final outcome (Time_at_Shelter) is related to the type of animal (Animal_type),the month the animal was admitted (Month), the year the animal was admitted to (Year), the reason for the animal being admitted (Intake_type), and status of a microchip with owner information (Chip_Status), which will be anlyzed below.
...
```{r,echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '68%', fig.align = "center",fig.cap = "\\label{fig:box} Figure 1:time_at_shelter by animal_type", fig.pos = 'H'}
...
```{r,echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '68%', fig.align = "center",fig.cap = "\\label{fig:box} Figure 2:time_at_shelter by year", fig.pos = 'H'}
...
```{r,echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '68%', fig.align = "center",fig.cap = "\\label{fig:box} Figure 3:time_at_shelter by month", fig.pos = 'H'}
...
```{r,echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '68%', fig.align = "center",fig.cap = "\\label{fig:box} Figure 4:time_at_shelter by intake_type", fig.pos = 'H'}
...
```{r,echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '68%', fig.align = "center",fig.cap = "\\label{fig:box} Figure 5:time_at_shelter by chip_status", fig.pos = 'H'}
...
After the initial graphical analysis of the relationship between the variables, we will use the GLM model to further analyse the relationship between the outcome variables (Time_at_Shelter)and the explanatory variables(Animal_type,Month,Year,Intake_type,Chip_Status), and the model will be based on poisson glm model with link function log.The outcome can be showed as follow,and we notice that the coefficient of year factor cannot be defined.There are some reasons for that,firstly the the explanatory variables month and year exist multicollinearity,and there are also some missing month data in 2016,finally we can also include that changes in year does not affect the outcome variable from Figure 2.
```{r,echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE}
